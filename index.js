class Code{
    ...
    getChar(){
        ...
        divs.style.cssText = `width:50px;height:50px;background:#999;border-radius:50%;text-align:center;line-height:50px;font-size:20px;position:absolute;top:${tops}px;left:${lefts}px;`
